        ...
        static void Main(string[] args)
        {
            ...
            switch (input)
            {
                ...
                case "3":
                    ...
                    if (int.TryParse(multiplyNumber1, out int multNumOne) && int.TryParse(multiplyNumber2, out int mulNumTwo))
                    {
                        Console.WriteLine($"{multiplyNumber1} * {multiplyNumber2} = ");
                        Console.WriteLine(calculator.Multiply(multNumOne, mulNumTwo));
